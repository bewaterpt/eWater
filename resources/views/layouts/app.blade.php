    ...
    <body>
        <div id="app">
            ...
            <div class="card float-right" id="bug-report">
                <a href="mailto:helpdesk@bewater.com.pt?subject=Bug%20Report: {{ $currentUser->name }}" title="{{ __('tooltips.report_a_bug') }}" class="btn btn-link btn-lg btn-primary text-white">
